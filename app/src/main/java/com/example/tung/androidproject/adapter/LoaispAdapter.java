...
public class LoaispAdapter extends BaseAdapter {
    ...
    public LoaispAdapter(ArrayList<Loaisanpham> listLoaisp, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.fillterloaisp, null);
            viewHolder.tvTenLoaiSP = convertView.findViewById(R.id.text_loaisp_search);
            viewHolder.imgLoaiSP = convertView.findViewById(R.id.image_loaisp_search);
